    ...
    >
      ...
      {seeAll ? (
        ...
        <Button
          ...
          fill="fill"
          onClick={handleSetSeeAll}
          className="w-full h-[200px] text-[#D93434] font-bold underline absolute bottom-0 bg-transparent [background-image:linear-gradient(to_top,white_40%,transparent_100%)]"
        >
