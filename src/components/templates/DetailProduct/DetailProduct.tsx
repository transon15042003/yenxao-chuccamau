...
const DetailProduct = ({ relatedProducts }: { relatedProducts: Product[] }) => {
  return (
    <div className="lg:grid lg:grid-cols-12 lg:max-w-[75%] max-w-full pb-4 lg:mt-2 bg-[#F2F2F2] lg:bg-white">
      ...
      <ProductSummary className="lg:col-span-5" />
      <ProductDetailInfo className="lg:col-span-12 col-span-1" />
      <div className="px-2 pt-3 lg:px-0 lg:col-span-12 bg-white">
