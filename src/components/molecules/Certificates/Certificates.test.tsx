// src/components/molecules/Certificates/Certificates.test.tsx
...
// Import các matcher mở rộng từ jest-dom (để dùng toBeInTheDocument, toHaveLength)
import '@testing-library/jest-dom';

// Import component Certificates cần test
import { Certificates } from './Certificates';

// describe: Gom nhóm các bài test cho component Certificates
